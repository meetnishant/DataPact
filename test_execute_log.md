...
tests/test_db_source.py::test_sqlite_load_and_infer_schema PASSED        [ 24%]
tests/test_db_source.py::test_sqlite_iter_chunks PASSED                  [ 25%]
...
ype_mismatch PASSED [ 28%]                                                      tests/test_exhaustive_features.py::TestSchemaValidationExhaustive::test_schema_e
xtra_columns_warn PASSED [ 29%]                                                 tests/test_exhaustive_features.py::TestSchemaValidationExhaustive::test_schema_d
...
icates PASSED [ 34%]                                                            tests/test_exhaustive_features.py::TestQualityRulesExhaustive::test_quality_minm
ax_boundary PASSED [ 35%]                                                       tests/test_exhaustive_features.py::TestQualityRulesExhaustive::test_quality_minm
ax_fail PASSED [ 36%]                                                           tests/test_exhaustive_features.py::TestQualityRulesExhaustive::test_quality_enum
_boundary PASSED [ 37%]                                                         tests/test_exhaustive_features.py::TestQualityRulesExhaustive::test_quality_enum
...
null_ratio_fail PASSED [ 41%]                                                   tests/test_exhaustive_features.py::TestSeverityExhaustive::test_rule_severity_va
lid PASSED [ 42%]                                                               tests/test_exhaustive_features.py::TestSeverityExhaustive::test_rule_severity_wa
rn PASSED [ 43%]                                                                tests/test_exhaustive_features.py::TestSeverityExhaustive::test_rule_severity_ov
erride PASSED [ 44%]                                                            tests/test_exhaustive_features.py::TestSeverityExhaustive::test_rule_severity_in
valid PASSED [ 45%]                                                             tests/test_exhaustive_features.py::TestSeverityExhaustive::test_invalid_severity
...
oundary PASSED [ 50%]                                                           tests/test_exhaustive_features.py::TestSLAAndFreshnessExhaustive::test_sla_min_f
ail PASSED [ 51%]                                                               tests/test_exhaustive_features.py::TestSLAAndFreshnessExhaustive::test_sla_max_f
ail_warn PASSED [ 52%]                                                          tests/test_exhaustive_features.py::TestSLAAndFreshnessExhaustive::test_freshness
...
ng_frac_deterministic PASSED [ 58%]                                             tests/test_exhaustive_features.py::TestCustomRulesExhaustive::test_custom_rule_m
issing PASSED [ 59%]                                                            tests/test_exhaustive_features.py::TestCustomRulesExhaustive::test_custom_rule_i
nvalid_config PASSED [ 60%]                                                     tests/test_exhaustive_features.py::TestPolicyPacksExhaustive::test_policy_pack_u
...
tests/test_reporting.py::test_file_report_sink_writes_json PASSED        [ 67%]
tests/test_reporting.py::test_stdout_report_sink_prints_json PASSED      [ 68%]
...
tests/test_validator.py::TestQualityValidator::test_invalid_email_regex PASSED [
 75%]                                                                           tests/test_validator.py::TestQualityValidator::test_null_constraint PASSED [ 75%
...
SED [ 83%]                                                                      tests/test_validator.py::TestSLAValidator::test_min_rows_violation PASSED [ 83%]
...
tests/test_db_source.py::test_mysql_load_table
	/Users/meetnishant/Documents/DataContracts/src/datapact/datasource.py:225: UserWarning: pandas only supports SQLAlchemy connectable (engine/connection) or database string URI or sqlite3 DBAPI2 connection. Other DBAPI2 objects are not tested. Please consider using SQLAlchemy.
		self.df = pd.read_sql_query(query, conn)

-- Docs: https://docs.pytest.org/en/stable/how-to/capture-warnings.html
======================== 113 passed, 1 warning in 1.58s ========================
```
